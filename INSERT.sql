...
values ('jbstaff1', '7181115678'),
values ('spiritstaff1', '7182229876'),
values ('sarausername', '7183337654');
...
INSERT INTO Flight(airline_name, flight_number, departure_datetime, departure_airport_name, arrival_datetime, arrival_airport_name, base_price, airplane_id, remaining_seats, status)
	values ('JetBlue', 1234, '2025-06-14 08:00:00.00', 'JFK', '2025-06-14 16:00:00.00', 'LAX', 200.00, 1, 52, 'on time');

INSERT INTO Ticket(customer_email, flight_number, departure_datetime, airline, sold_price, card_type, card_number, exp_date, purchase_datetime, comments, rating)
